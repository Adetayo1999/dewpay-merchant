...
export const TableDropDown: React.FC<{
  options: { title: string; onClick?: VoidFunction }[];
}> = ({ options }) => {
    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <motion.ul
          ...
          exit={{ opacity: 0, y: -10 }}
          className="absolute  mt-1 bg-white border-[#DEE2E6] border z-[100000] shadow-[0px_0px_2px_0px_#0000001F] rounded-lg w-[11.25rem] overflow-hidden"
        >
