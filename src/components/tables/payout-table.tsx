...
export const PayoutTable = () => {
  ...
  const { data, isLoading } = useQueryTransactionsQuery({
    offset: (currentPage - 1) * limit,
    limit: limit,
    from_date: dateRange.from.toISOString(),
    to_date: dateRange.to.toISOString(),
    type: "merchant_transfer_money",
  });
            ...
            <div className="text-center min-h-[20rem] flex justify-center items-center">
              <div className="flex flex-col items-center justify-center py-12">
                ...
                <p className="text-base text-gray-600">
                  Please generate a payment link for your customers to make
                  transactions with{" "}
                  <button className="text-primary hover:text-green-700 font-semibold text-lg underline decoration-2 underline-offset-2">
